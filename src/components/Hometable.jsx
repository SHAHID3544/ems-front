            ...
            displayData.length > 0 ?
              ...
              displayData.map((item, index) => (
                ...
                <tr>
                  ...
                  <td><img style={{ width: '50px', borderRadius: '50%' }} src={`${BASE_URL}/uploads/${item.profile}`} alt="no image" /></td>
                  <td>
                    <Link to={`/view/${item._id}`} ><i class="fa-solid fa-eye fs-3 me-2 text-light"></i></Link>
                    <Link to={`/edit/${item._id}`}><i class="fa-solid fa-pen fs-3 me-2 text-dark"></i></Link>
